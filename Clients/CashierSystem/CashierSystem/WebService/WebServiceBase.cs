...
namespace CashierSystem.WebService
{
    ...
    {
        protected HttpCustomResult MakeHttpRequest(string url, object data, HttpVerbs method = HttpVerbs.Post)
        {
            try
            {
                ...
                if (method == HttpVerbs.Post && data != null)
                {
            ...
            catch (WebException e)
            {
                ...
                //Ignore everything else currently (BAD)
                return null;
            }
        }
